...
/**
 * Error thrown when the SQLite MCP extension cannot be found
 */
...
/**
 * Gets the absolute path to the SQLite MCP extension binary for the current platform
 *
 ...
 * // On macOS ARM64: /path/to/node_modules/@sqliteai/sqlite-mcp-darwin-arm64/mcp.dylib
 * ```
 */
export function getExtensionPath(): string {
  ...
  throw new ExtensionNotFoundError(
    `SQLite MCP extension not found for platform: ${currentPlatform}\n\n` +
...
export interface ExtensionInfo {
  ...
  packageName: string;
  /** Filename of the binary (e.g., 'mcp.dylib') */
  binaryName: string;
...
/**
 * Gets detailed information about the SQLite MCP extension
 *
 ...
 * //   packageName: '@sqliteai/sqlite-mcp-darwin-arm64',
 * //   binaryName: 'mcp.dylib',
 * //   path: '/path/to/mcp.dylib'
 * // }
 * ```
 */
